...
public class mainGUI extends JPanel{
	...
	public mainGUI(JXC_View view,mainFrame jframe){
		this.view=view;
		this.jframe=jframe;
		...
		helper.setFilename("clientData/current.txt");
	...
	class buttonMouseAdapterAndActionListener extends MouseAdapter implements ActionListener{
		...
		if(i==3&&position.equals("销售人员")){
			setVisible(false);
			jframe.setContentPane(new customerGUI(view,jframe));
		}else{}
	    if(i==4&&position.equals("仓库管理员")){
			setVisible(false);
			jframe.setContentPane(new stockGUI(view,jframe));
		}else{}
	    if(i==5&&position.equals("销售人员")){
	    	setVisible(false);
			jframe.setContentPane(new importGUI(view,jframe));
	    }else{}
	    if(i==6&&position.equals("销售人员")){
	    	setVisible(false);
			jframe.setContentPane(new exportGUI(view,jframe));
	    }else{}
	    if(i==7&&position.equals("财务人员")){
	    	setVisible(false);
			jframe.setContentPane(new accountGUI(view,jframe));
	    }else{}
	    if(i==8){
	    	setVisible(false);
