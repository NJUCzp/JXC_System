...
public class AccountManagement {
	...
	public void go(){
		...
		case "IN:":{
			...
			messageText="graphics/account/account_success_in.png";
		...
		case "OUT":{
			...
			messageText="graphics/account/account_success_out.png";
		...
		case "DET":{
			...
			helper1.setFilename("data/accountsheet.txt");
			ArrayList<String>info=helper1.readfile();
			System.out.println(info.size());
			int n=info.size();
			messageTable=new Object[n][5];
	...
	public void changeCusInfo(String name,int cashReceive,int cashPay){
		...
		for(int i=0;i<n;i++){
			System.out.println(cus.get(i).getName()+"  "+name);
	...
	public void outputAccSheet(String date,String s,String name,int cash){
		...
		if(info.size()!=0&&info.get(0).equals(""))
			info.remove(0);
